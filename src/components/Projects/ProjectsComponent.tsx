    ...
    >
      ...
      <div className={`relative overflow-hidden ${isLarge ? 'h-64 md:h-80' : 'h-52'}`}>
        <Image
          ...
          className="object-cover saturate-100 opacity-95 group-hover:saturate-[1.3] group-hover:opacity-100 group-hover:scale-110 transition-all duration-700"
        />
        <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10" />
      </div>
