        ...
        <div className="wrapper w-[80%] h-[100%] m-auto lg:flex justify-center items-center gap-[50px]">
          ...
          >
            ...
            <div className="flex items-center gap-2">
             ...
             <button className="disable b-0 rounded-xl p-2 px-3 w-[200px] cursor-pointer bg-slate-300 font-bold flex justify-center items-center  text-black gap-2 hover:bg-sky-300">
